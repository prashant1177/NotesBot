...
export const metadata = {
  title: 'Contact LaTeXWriter - Get in Touch for LaTeX Help & Support',
  description: 'Reach out to LaTeXWriter for queries, support, or feedback. Your go-to platform for LaTeX tutorials, documentation, and expert guidance.',
  alternates: {
    canonical: "https://latexwriter.com/contact",
  },
};
