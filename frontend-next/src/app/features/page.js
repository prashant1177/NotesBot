...
export const metadata = {
  ...
  description: 'Explore LaTeXWriter’s powerful features including real-time collaboration, fast PDF compilation, templates, and expert LaTeX support for researchers and students.',
  alternates: {
          ...
          <div className="text-left w-full mt-12 md:mt-24 h-fit">
            ...
            <section className="mb-16 bg-white rounded-2xl  p-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li className="flex items-start">
                    <span className="bg-gray-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm mr-3 mt-0.5">4</span>
                    Click Commit.
                  </li>
                  <li className="flex items-start">
                    <span className="bg-gray-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm mr-3 mt-0.5">5</span>
                    To restore, go to Older Versions, select the commit, and click Restore.
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-16 bg-white rounded-2xl  p-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li className="flex items-start">
                    <span className="bg-gray-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm mr-3 mt-0.5">2</span>
                    Click on the symbol, and it will automatically insert into your document.
                  </li>
                </ul>
              </div>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h5 className="font-semibold text-gray-800 mb-2">Available Categories:</h5>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <h5 className="font-semibold text-gray-800 mb-2">More Categories:</h5>
                  <ul className="text-sm text-gray-700 space-y-1">
                    <li>• Arrows</li>
            ...
            <section className="mb-16 bg-white rounded-2xl  p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h4 className="text-lg font-bold text-gray-800 mb-3">Preview Modes:</h4>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h4 className="text-lg font-bold text-gray-800 mb-3">How to Use:</h4>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                      <span className="bg-gray-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm mr-3 mt-0.5">1</span>
            ...
            <section className="mb-16 bg-white rounded-2xl  p-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li className="flex items-start">
                    <span className="bg-gray-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm mr-3 mt-0.5">3</span>
                    You'll get a detailed explanation of the error and instructions to fix it.
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="mb-16 bg-white rounded-2xl  p-8">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <ul className="space-y-2 text-gray-700">
                  ...
                  <li className="flex items-start">
                    <span className="bg-gray-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm mr-3 mt-0.5">2</span>
                    Type your question (e.g., "How do I add a bibliography in LaTeX?").
                  </li>
                  <li className="flex items-start">
                    <span className="bg-gray-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm mr-3 mt-0.5">3</span>
