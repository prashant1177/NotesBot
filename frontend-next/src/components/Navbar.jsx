          ...
          <div className="hidden md:flex items-center ">
            <ul className="flex items-center space-x-8 text-gray-600">
              ...
              <li>
                <Link
                  href="/features"
                  className={`transition-colors ${isActiveLink("/features")}`}
                >
                  Features
                </Link>
              </li>
            ...
            <div className="px-4 py-4 space-y-4">
              ...
              <ul className="space-y-4">
                <li>
                  <Link
                    href="/"
                    className={`block transition-colors py-2 ${isActiveLink(
                      "/"
                    )}`}
                ...
                <li>
                  <div className="space-y-2">
                    ...
                    <div className="ml-4 space-y-2">
                      <Link
                        href="/documentation/latex/getting-started-latex"
                        className="block px-4 py-2 text-gray-800 hover:bg-gray-100 transition-colors rounded"
                        onClick={() => setIsMenuOpen(false)}
                      >
                        Latex
                      </Link>
