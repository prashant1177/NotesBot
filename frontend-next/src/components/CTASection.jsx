...
export function CTASection() {
  return (
    <section className="relative overflow-hidden w-full h-screen flex justify-center">
      <img
        src="/downloadnowimage.webp"
        className="object-cover w-full"
        alt="Latex Writer - Image  of a man having laptop on his lap with latex writer editor interface"
      />
      <div className="absolute w-full  bg-gray-950/90 h-full ">
        <div className="md:w-5/6  mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center">
          <div className="w-fit inline-flex items-center px-4 py-2 rounded-full border border-gray-600 mb-8 bg-gray-700/50">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-4 md:items-center my-12">
